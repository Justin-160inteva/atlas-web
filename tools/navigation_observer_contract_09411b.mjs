...
check('nested cards disable backdrop filter', /Nested cards stay crisp[\s\S]*-webkit-backdrop-filter:none!important;[\s\S]*backdrop-filter:none!important/.test(css));
